...
export default function StatsPage() {
  ...
  if (!stats) return <div className="text-gray-500 p-8">Lädt …</div>;
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-pokemon-card rounded-lg p-4">
          ...
          <div className="text-gray-500 text-xs mt-1">Karten erfasst</div>
        </div>
        <div className="bg-pokemon-card rounded-lg p-4">
          <div className="text-gray-400 text-sm">Besossen</div>
          <div className="text-3xl font-bold text-green-400">{stats.besessen}</div>
          <div className="text-gray-500 text-xs mt-1">{pct}% der Sammlung</div>
        ...
        <div className="bg-pokemon-card rounded-lg p-4">
          ...
          <div className="text-gray-500 text-xs mt-1">Cardmarket (besessen)</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-6">
        <div className="bg-pokemon-card rounded-lg p-4">
          <StatsDonut data={stats.seltenheiten} title="Seltenheit" />
        </div>
        <div className="bg-pokemon-card rounded-lg p-4">
          <StatsDonut data={stats.sprachen} title="Sprachen" />
        </div>
      </div>

      {/* Top 10 */}
      <div className="bg-pokemon-card rounded-lg p-4">
        <h2 className="text-gray-300 font-medium mb-3">Top 10 teuerste Karten</h2>
        <table className="w-full text-sm">
          <thead>
            <tr className="text-gray-500 text-xs border-b border-gray-800">
              <th className="text-left pb-2">Karte</th>
      ...
      {/* Zuletzt hinzugefügt */}
      <div className="bg-pokemon-card rounded-lg p-4">
        <h2 className="text-gray-300 font-medium mb-3">Zuletzt hinzugefügt</h2>
