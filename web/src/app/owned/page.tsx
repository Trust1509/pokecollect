  ...
  return (
    <div>
      ...
      <div className="mb-3">
        ...
        <p className="text-gray-400 text-sm hidden sm:block">{t.collections_all_owned_desc}</p>
      </div>

      {/* Anzahl + Wert (Mobile eine Zeile, Desktop Karten) */}
      <div className="sm:hidden flex items-center justify-between bg-pokemon-card rounded-lg px-3 py-2 mb-3 text-sm">
      ...
      <div className="hidden sm:flex gap-4 mb-4 text-sm">
      ...
      <div className="flex flex-col gap-4">
        <FilterSidebar filters={filters} onChange={handleFilters} enums={enums} sets={sets} />
        ...
        <div className="flex-1 min-w-0">
          {loading ? (
            ...
            <>
              {data && data.pages > 1 && (
                <div className="flex justify-end gap-2 text-sm items-center mb-3">
