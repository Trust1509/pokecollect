...
const DE = {
  ...
  sealed_value_hint: "Manuell gepflegt — keine automatische Preisquelle für Sealed",
  sealed_photo: "Foto",
...
const EN: typeof DE = {
  ...
  sealed_value_hint: "Maintained manually — no automatic price source for sealed",
  sealed_photo: "Photo",
