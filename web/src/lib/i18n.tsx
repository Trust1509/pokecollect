...
const DE = {
  ...
  form_card_nr_hint: (max: number) => `Format: NNN/${String(max).padStart(3, "0")} (z.B. 001/${String(max).padStart(3, "0")})`,
  form_card_nr_invalid: (max: number) => `Ungültiges Format. Erwartet: NNN/${String(max).padStart(3, "0")}`,
...
const EN: typeof DE = {
  ...
  form_card_nr_hint: (max: number) => `Format: NNN/${String(max).padStart(3, "0")} (e.g. 001/${String(max).padStart(3, "0")})`,
  form_card_nr_invalid: (max: number) => `Invalid format. Expected: NNN/${String(max).padStart(3, "0")}`,
  form_rarity: "Rarity",
