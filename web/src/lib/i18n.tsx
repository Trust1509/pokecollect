...
const DE = {
  ...
  scan_camera_insecure: "Live-Webcam braucht einen sicheren Kontext (HTTPS).\nSchnellster Weg in Chrome/Edge: chrome://flags/#unsafely-treat-insecure-origin-as-secure öffnen, dort http://<server-ip>:3011 eintragen, aktivieren, Browser neu starten. Alternativ „Foto aufnehmen / auswählen“ nutzen.",
...
const EN: typeof DE = {
  ...
  scan_camera_insecure: "The live webcam needs a secure context (HTTPS).\nQuickest in Chrome/Edge: open chrome://flags/#unsafely-treat-insecure-origin-as-secure, add http://<server-ip>:3011, enable it and restart the browser. Otherwise use “Take / choose photo”.",
